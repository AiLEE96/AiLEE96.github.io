...
# Github.io
 ...
 ![install01](/assets/img/Github-io/io02.png)
 
 ```
 깃허브 레포지터리를 새롭게 생성, 이때 레포지터리의 명칭은 [사용자의 이름].github.io 이어야 한다.
 ```

 ![install01](/assets/img/Github-io/io04.png)

 ```
 깃허브 데스크톱을 이용해서 추가 된 레포지터리를 확인.
 ```

 ![install01](/assets/img/Github-io/io05.png)

 ![install01](/assets/img/Github-io/io06.png)

 ```
 생성되어 있는 레포지터리를 클론.
 ```

 ![install01](/assets/img/Github-io/io07.png)

 ```
 Github.io를 이용하기 위해선 윈도우에 Ruby가 설치되어 있어야 함으로 Ruby 설치.
 ```

 ![install01](/assets/img/Github-io/io08.png)

 ![install01](/assets/img/Github-io/io09.png)

 ```
 Ruby가 정상적으로 설치되었다면 Start Command prompt with Ruby를 볼 수 있다.
 ```

 ![install01](/assets/img/Github-io/io10.png)
 ...
 http://127.0.0.1:4000/
 ```
 ![install01](/assets/img/Github-io/io11.png)

 페이지가 정상적으로 출력된다. 테스트가 끝난 파일들을 그대로 깃허브에 업로드.

 ![install01](/assets/img/Github-io/io12.png)

 사진과 같이 업로드가 끝나게 되면 아래처럼 github.io가 정상적으로 동작한다. 

 ![install01](/assets/img/Github-io/io13.png)

# Github.io theme

 ![install01](/assets/img/Github-io/io14.png)
...
```
 ...
 ![install01](/assets/img/Github-io/io15.png)

 ![install01](/assets/img/Github-io/io16.png)
 ...
 ![install01](/assets/img/Github-io/io17.png)
 ...
 ![install01](/assets/img/Github-io/io18.png)
