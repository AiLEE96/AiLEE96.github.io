...
```
 ...
 ![install01](/img/img/KTcoud/NAS/NAS01.png)

 ```
 NAS - NAS volume - 볼륨생성
 ```

 ![install01](/img/img/KTcoud/NAS/NAS02.png)
...
![install01](/img/img/KTcoud/NAS/NAS03.png)
...
```
 ...
 -df -h #디스크 확인
```
![install01](/img/img/KTcoud/NAS/NAS04.png)
...
![install01](/img/img/KTcoud/NAS/NAS05.png)
...
![install01](/img/img/KTcoud/NAS/NAS06.png)

```
 윈도우 서버 생성
```

![install01](/img/img/KTcoud/NAS/NAS07.png)

```
 생성된 서버 네트워크 연결.
```

![install01](/img/img/KTcoud/NAS/NAS08.png)
...
![install01](/img/img/KTcoud/NAS/NAS09.png)

![install01](/img/img/KTcoud/NAS/NAS10.png)

![install01](/img/img/KTcoud/NAS/NAS11.png)

```
 IP 입력 - 사용자 입력(Administrator) - 비밀번호 입력(서버가 생성 될 때 부여 된 비밀번호)
```

![install01](/img/img/KTcoud/NAS/NAS12.png)

```
 윈도우 서버에 접속 - 내 PC - 네트워크 드라이브 연결 - \\NAS(CIFS)아이피 주소\mountpath 입력.
```

![install01](/img/img/KTcoud/NAS/NAS13.png)
