...
# Install Blazemeter
 ...
 ![install01](/img/img/Jmeter/Blaze01.png)

```
 크롬 웹 스토어에서 설치가 가능한 Blazemeter는 Jmeter를 보다 효율적이고 쉽게 사용하도록 도와주는 툴.
```

![install01](/img/img/Jmeter/Blaze02.png)

```
 웹 스토어에서 인스톨이 끝나면 웹 확장 - 블레이즈 미터 선택
```

![install01](/img/img/Jmeter/Blaze03.png)

```
 스타트 레코딩을 클릭, 특정 모션을 수행 하면 해당 모션을 통해서 발생한 이벤트가 저장이 된다.
```

![install01](/img/img/Jmeter/Blaze04.png)

```
 동영상 중지
```

![install01](/img/img/Jmeter/Blaze05.png)

```
 다시 한 번 확장 프로그램 클릭 - 블레이즈 미터 클릭 - 세이브 클릭
```

![install01](/img/img/Jmeter/Blaze06.png)

![install01](/img/img/Jmeter/Blaze07.png)

```
 Jmeter 선택 - Domains to includ에서 가장 상단 선택 - 세이브 클릭 
```

![install01](/img/img/Jmeter/Blaze08.png)
...
![install01](/img/img/Jmeter/Jmeter01.png)

```
 Jmeter 홈페이지 접속 - Download Releases
```

![install01](/img/img/Jmeter/Jmeter02.png)
...
![install01](/img/img/Jmeter/Jmeter03.png)

```
 Jmeter 설치가 완료 되고 나면 bin - jmeter.bat을 실행
```

![install01](/img/img/Jmeter/Jmeter04.png)

```
 만약 자바가 설치가 안됐다면 이런 에러 메시지가 출력된다.
```

![install01](/img/img/Jmeter/Jmeter05.png)
...
![install01](/img/img/Jmeter/JDK05.png)

![install01](/img/img/Jmeter/JDK06.png)

![install01](/img/img/Jmeter/JDK07.png)

![install01](/img/img/Jmeter/JDK08.png)

![install01](/img/img/Jmeter/JDK09.png)
...
![install01](/img/img/Jmeter/Jmeter06.png)

```
Jmeter 화면에서 Open 클릭
```

![install01](/img/img/Jmeter/Jmeter07.png)

```
 Blaze meter에 의해서 생성 된 Jmx 파일을 선택
```

![install01](/img/img/Jmeter/Jmeter08.png)

```
 스레드 그룹에서 Number of threads(트래픽, 또는 유저의 수), Ramp-up period(부하를 주는 시간) 설정.
```

![install01](/img/img/Jmeter/Jmeter11.png)
...
![install01](/img/img/Jmeter/Jmeter12.png)


![install01](/img/img/Jmeter/Jmeter13.png)
